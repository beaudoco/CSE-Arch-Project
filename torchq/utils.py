...
from .layers import QuantumModuleFromOps, RandomLayerAllTypes
...
def build_module_description_test():
    ...
    from .plugins.qiskit_plugin import tq2qiskit
    ...
    desc = build_module_op_list(RandomLayerAllTypes(
...
def partial_trace_test():
    # f functional as tqf
    from .functional import hadamard, cnot

    n_wires = 4
    q_device = QuantumDevice(n_wires=n_wires)

    hadamard(q_device, wires=0)
    cnot(q_device, wires=[0, 1])
