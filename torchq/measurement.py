...
from .operators import Observable, I, op_name_dict
from .module import QuantumModule
from typing import Union, List
from collections import Counter, OrderedDict


def expval(q_device: QuantumDevice,
...
class MeasureMultipleTimes(QuantumModule):
    """
    obs list:
    ...
    def forward(self, q_device: QuantumDevice):
        ...
        for layer in self.obs_list:
            ...
            q_device_new = QuantumDevice(n_wires=q_device.n_wires)
            ...
            for wire, observable in zip(layer['wires'], layer['observables']):
                observables[wire] = op_name_dict[observable]()
...
class MeasureMultiPauliSum(QuantumModule):
    """
