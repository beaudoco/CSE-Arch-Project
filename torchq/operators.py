...
from .noise_model import NoiseModelTQPhase
from .quantization.clifford_quantization import CliffordQuantizer
...
class Operator(QuantumModule):
    ...
    def forward(self, q_device: QuantumDevice, wires=None, params=None,
                inverse=False):
        ...
        if self.params is None:
            ...
            if isinstance(self.noise_model_tq, NoiseModelTQPhase):
